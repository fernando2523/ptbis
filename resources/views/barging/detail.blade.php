        ...
        <div class="col-xl-9 col-lg-9">
            <div class="card mb-3" >
                <div class="card-body" style="height: 236px;">
                    <div class="d-flex fw-bold small mb-3">
                        <span class="flex-grow-1">ACTIVITY BARGING LOG</span>
    ...
    <div class="col-xl-12">
        <div class="card">
            <div class="card-body p-3" style="height: auto;">
                    <div class="d-flex fw-bold small mb-3">
                        <span class="flex-grow-1">DATA REPORT DETAIL BARGING</span>
                        <a href="#" data-toggle="card-expand" class="text-white text-opacity-50 text-decoration-none"><i class="bi bi-fullscreen"></i></a>
                    </div>
                    <div class="input-group mb-4">
                        <div class="flex-fill position-relative">
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control ps-35px" id="search_barging" placeholder="Search ritase.." />
                            </div>
                        </div>
                    </div>
                    <table class="table-sm table-bordered mb-0" style="width: 100%" id="tb_barging">
...
<script type="text/javascript">
    $(function () {
    var table = $('#tb_barging').DataTable({
    lengthMenu: [10],
    responsive: true,
    processing: false,
    serverSide: true,
    ajax: "/datatablebarging",
    columns: [
    ...
    $('#search_barging').on( 'keyup', function () {
...
@include('barging.edit')
@include('barging.delete')
...
<script>
    ...
    function submitformedit() {
        ...
        document.getElementById('form_edit').action = "../barging/editact/"+value;
    ...
    function submitformdelete() {
        ...
        document.getElementById('form_delete').action = "../barging/destroy/"+value;
